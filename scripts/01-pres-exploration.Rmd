...
fidalgo_bay <- filter(popul_days_sep, str_detect(Sample_Name, "NF"), na.rm = TRUE)
oyster_bay <- filter(popul_days_sep, str_detect(Sample_Name, "SS"), na.rm = TRUE)
daobob_bay <- filter(popul_days_sep, str_detect(Sample_Name, "HC"), na.rm = TRUE)
